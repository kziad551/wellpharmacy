...
<style>
  ...
  .authcard h1{font-family:var(--fp);font-size:clamp(26px,3vw,34px);font-weight:600;margin:0 0 6px}
  ...
  .acct-head h1{font-family:var(--fp);font-size:clamp(28px,3.4vw,40px);font-weight:600;margin:0}
  ...
  .panel h2{font-family:var(--fp);font-size:22px;font-weight:600;margin:0 0 18px}
