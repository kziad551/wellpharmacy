...
<style>
  ...
  .hero .wrap{max-width:1400px; display:grid; grid-template-columns:1.05fr .95fr; gap:clamp(24px,4vw,56px); align-items:center; padding-block:clamp(40px,6vw,80px) clamp(34px,5vw,64px)}
