...
<style>
  ...
  .jr-hero h1{font-family:var(--fp);font-size:clamp(32px,4vw,48px);font-weight:600;margin:10px 0 8px;letter-spacing:-.02em}
  .jr-hero .sub{color:var(--ink-soft);font-size:16px;max-width:60ch}
  .jr-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:22px;padding-block:40px 20px}
  ...
  @media(max-width:980px){.jr-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
  @media(max-width:640px){.jr-grid{grid-template-columns:minmax(0,1fr)}}
</style>
CSS;
