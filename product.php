...
<style>
  ...
  .pdp-right{min-width:0; display:flex; flex-direction:column}   /* buy box + tabs share the column so the image stays pinned through everything */
  ...
  .pdp-tabs{border-bottom:1px solid var(--border-2); padding-bottom:8px}
  .pdp-tabs .pill-tabs{margin-left:0; flex-wrap:wrap; gap:6px}
