...
(function (W) {
  ...
  const MENU = {
    ...
    Offers:{ offers:true, cols:[{h:"Today's Deals",links:["Today's Deals","Up to 50% Off","Bundle & Save","Clearance"]},{h:'Coupons',links:(W.COUPONS && W.COUPONS.length) ? W.COUPONS : ['No coupons right now']},{h:'Shop Deals',links:['Skincare Sale','Wellness Sale','Makeup Sale','Mom & Baby Sale']}], feat:{img:W.IMG.heroSerum,ey:'Limited Time',t:'The Well Sale Event',cta:'Shop All Deals'} },
  };
